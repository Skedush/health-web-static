...
export default {
  ...
  [getVolunteer](req: Request, res: Response) {
  ...
  [addVolunteer](req: Request, res: Response) {
  ...
  [updateVolunteer](req: Request, res: Response) {
    console.log('req: ', req.body);
    const data = 1;
    if (data) {
      res.json(ResponseWarpper.success(data));
  ...
  [deleteVolunteer](req: Request, res: Response) {
